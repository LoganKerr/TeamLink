...
function addField(e)
{
    ...
    removeRoleButton.addEventListener("click", function() { console.log(tempId); document.getElementById("role_new"+tempId).remove(); document.getElementById("role_new_button"+tempId).remove();  });
    boxId++;
}
